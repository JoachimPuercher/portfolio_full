...
/**
 * Global 404 for requests outside a locale segment (the proxy normally prefixes
 * every path with a locale, so this is rarely reached).
 */
      ...
      <body className="bg-main-white font-bricolage text-main-black">
        <main className="flex min-h-dvh flex-col items-center justify-center gap-6 p-4 text-center">
          ...
          <p className="section-text-typo flex gap-6">
            <Link className="text-main-blue hover:text-main-yellow" href="/de">
              Zur Startseite
            </Link>
            <Link className="text-main-blue hover:text-main-yellow" href="/en">
              Go to home page
            </Link>
          </p>
        </main>
